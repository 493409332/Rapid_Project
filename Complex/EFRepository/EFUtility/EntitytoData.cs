...
namespace Complex.Repository.Utility
{
    ...
    { 
        protected override void Seed(EntitytoData context)
        {
            ...
            context.T_User.Add(new T_User() { UserName = "admin", Password = "E10ADC3949BA59ABBE56E057F20F883E", TrueName="初始化管理员", IsAdmin=true });
            ...
            context.T_Navigation.Add(new T_Navigation() { ID = 6, NavTitle = "操作日志", iconCls = "icon-page_error", Linkurl = "#", iconUrl = "/Content/iconcss/icon/page_error.png", ParentID = 1, Sortnum = 95, BigImageUrl = "/Content/iconcss/icon/32/page_error.png", IsSys = true });

            context.T_Navigation.Add(new T_Navigation() { ID = 6, NavTitle = "个性化设置", iconCls = "icon-wrench_orange", Linkurl = "#", iconUrl = "/Content/iconcss/icon/wrench_orange.png", ParentID = 1, Sortnum = 94, BigImageUrl = "/Content/iconcss/icon/32/palette.png", IsSys = true }); 

            context.T_Navigation.Add(new T_Navigation() { ID = 7, NavTitle = "DEMO", iconCls = "icon-note", Linkurl = "#", iconUrl = "/Content/iconcss/icon/note.png", ParentID = 0, Sortnum = 2, BigImageUrl = "/Content/iconcss/icon/32/note.png", IsSys = true });

            context.T_Button.Add(new T_Button() { ID = 1, ButtonTag = "add", iconCls = "icon-add", ButtonText = "添加", IconUrl = "", Remark = "", Sortnum = 100, IsSys = true });
            context.T_Button.Add(new T_Button() { ID = 2, ButtonTag = "delete", iconCls = "icon-delete3", ButtonText = "删除", IconUrl = "", Remark = "", Sortnum = 99, IsSys = true });
            context.T_Button.Add(new T_Button() { ID = 3, ButtonTag = "edit", iconCls = "icon-pencil", ButtonText = "编辑", IconUrl = "", Remark = "", Sortnum =98, IsSys = true });
            context.T_Button.Add(new T_Button() { ID = 4, ButtonTag = "search", iconCls = "icon-search", ButtonText = "查询", IconUrl = "", Remark = "", Sortnum =97, IsSys = true });
            context.T_Button.Add(new T_Button() { ID = 5, ButtonTag = "inport", iconCls = "icon-database_copy", ButtonText = "导入", IconUrl = "", Remark = "", Sortnum = 96 });
            context.T_Button.Add(new T_Button() { ID = 6, ButtonTag = "export", iconCls = "icon-page_excel", ButtonText = "导出", IconUrl = "", Remark = "", Sortnum = 95 });
            context.T_Button.Add(new T_Button() { ID = 7, ButtonTag = "set", iconCls = "icon-wrench_orange", ButtonText = "设置", IconUrl = "", Remark = "", Sortnum = 94 });
            context.T_Button.Add(new T_Button() { ID = 8, ButtonTag = "audit", iconCls = "icon-user_magnify", ButtonText = "审核", IconUrl = "", Remark = "", Sortnum = 93 });
            context.T_Button.Add(new T_Button() { ID = 9, ButtonTag = "upload", iconCls = "icon-folder_up", ButtonText = "上传", IconUrl = "", Remark = "", Sortnum =92 });
            context.T_Button.Add(new T_Button() { ID = 10, ButtonTag = "download", iconCls = "icon-download", ButtonText = "下载", IconUrl = "", Remark = "", Sortnum = 91 });
            context.T_Button.Add(new T_Button() { ID = 11, ButtonTag = "browser", iconCls = "icon-eye", ButtonText = "浏览", IconUrl = "", Remark = "所有页面必须有此权限方可访问!", Sortnum = 1 });
