require.config({
    ...
    paths: {
        ...
        "utility": "/Areas/Admin/Views/Index/utility",
        ...
        jquery: "~/Scripts/jquery/jquery-1.7.1.min"
    },
    shim: {
        jquery: {
            exports: "jquery"
...
require(["layout", "testui", "css!./Css/Global.css", "css!./Css/menu-tree.css",
    "panel", "scrollbar", "tree.menu", "tab", "utility"],
function ()
{
    ...
    var zNodes = [
        ...
        { id: 113, pid: 11, name: "广州", url: "http://www.baidu.com", guid: "hehe" },
