    ...
    "panel", "scrollbar", "tree.menu", "tab"], function ()
{
    ...
    var zNodes = [
        ...
        { id: 114, pid: 11, name: "时间管理呵呵呵呵的发" },
          { id: 111, pid: 11, name: "北京", url: "Index/test", guid: "test3" },
        ...
        { id: 2, pid: 0, name: "酒店", "iconSkin": "hotel" ,open: true,url:"http://www.baidu.com"},
     ...
     var tree = avalon.mix(true, {}, avalon.treeMenu, {
        ...
        { 
            ...
            onClick: function (data)
            {
                ...
                if (data.leaf.url != "" && typeof (data.leaf.guid) != "undefined" && data.leaf.guid != "" && !avalon.vmodels.tabVM.selecttabname(data.leaf.guid))
                {
                        ...
                        { 
                            avalon.vmodels.tabVM.add({
                                ...
                                name: data.leaf.guid,
                                content: '<div  ms-include-src="page.' + data.leaf.guid + '">aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa</div>'
                            });
