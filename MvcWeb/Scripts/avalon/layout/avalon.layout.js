        ...
        var widget = avalon.ui[widgetName] = function(element, data, vmodels) {
            ...
            var vmodel = avalon.define(data[widgetName+'Id'], function(vm) {
                ...
                avalon.mix(true, vm, {
                    ...
                    westRegion: { resizable: false, size: 0, regionClass: "", inLayoutFlow: false, isNested: false, realSize: 0, htmltxt: "Please set the default htmltxt" },
                    eastRegion: { resizable: false, size: 0, regionClass: "", inLayoutFlow: false, isNested: false, realSize: 0, htmltxt: "Please set the default htmltxt" },
                    southRegion: { resizable: false, size: 0, regionClass: "", inLayoutFlow: false, isNested: false, realSize: 0, htmltxt: "Please set the default htmltxt" },
                    northRegion: { resizable: false, size: 0, regionClass: "", inLayoutFlow: false, isNested: false, realSize: 0, htmltxt: "Please set the default htmltxt" }
                }, options);
                    ...
                    ["northRegion", "westRegion", "eastRegion", "southRegion", "centreRegion"].forEach(function(region) {
                        ...
                        if (vm[region].inLayoutFlow) {
                            ...
                            if (!childNodesDictionary[regionName]) {
                                domCreator.innerHTML = "<div>" + vm[region].htmltxt + "</div>";
